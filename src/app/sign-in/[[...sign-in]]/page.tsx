    ...
    <div className="min-h-screen flex">
        ...
        <div className="relative z-10 flex flex-col h-full p-12">
          ...
          <div className="mt-auto mb-auto pt-24">
            ...
            <p className="text-slate-400 text-base leading-relaxed max-w-xs">
              Curated medical literature, AI-powered summaries, and clinical insights — all in one place.
            </p>
          </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 bg-slate-50">
        ...
        <div className="w-full max-w-sm">
          ...
          <p className="text-slate-500 text-sm mb-8">Sign in to your ArticleOS account</p>
